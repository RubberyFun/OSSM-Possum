...
1. Get it from the Google Play store.  This is WIP - estimated public launch will be 2/14/2026 due to Google red tape. You can get the test version at [https://play.google.com/store/apps/details?id=com.rubberyfun.ossmpossum.app](https://play.google.com/store/apps/details?id=com.rubberyfun.ossmpossum.app)
...
- If you use a browser and not the app: Safari and Firefox are not onboard with web pages having access to bluetooth...and they never will be for better or worse.  You need Chrome for the web version...oh and Apple has a stranglehold on iOS chrome, so it won't work for iOS at all without an app (but chrome on Mac does).
